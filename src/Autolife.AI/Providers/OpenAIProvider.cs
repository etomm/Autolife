...
public class OpenAIProvider : IAIProvider
{
    ...
    public string Name => $"OpenAI ({_config.Model})";
    ...
    public async Task<string> GenerateCompletionAsync(string prompt, CancellationToken cancellationToken = default)
    {
        ...
        return $"[OpenAI Response] {prompt.Substring(0, Math.Min(50, prompt.Length))}...";
    }
    ...
    {
        await Task.Delay(100, cancellationToken);
        return new List<string> { "AI-Generated", "OpenAI", "Auto-Tagged" };
    }
